                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="rpt100 mt-30">
                                                    <ul class="radio--group-inline-container_1">
                                                        ...
                                                        <li>
                                                            <div class="radio-item_1">
                                                                <input id="payoneer1" value="payoneer"
                                                                    name="paymentmethod" type="radio"
                                                                    data-minimum="50.0">
                                                                <label for="payoneer1"
                                                                    class="radio-label_1">Payoneer</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="radio-item_1">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="pymnt_title">
                                                                ...
                                                                <p>Get paid by credit or debit card, PayPal transfer or even
                                                                    ...
                                                                    your email address or mobile number. <a
                                                                        href="#">More about PayPal</a> | <a
                                                            ...
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                                    <input class="prompt srch_explore" type="email"
                                                                        ...
                                                                        id="id_email1" required="" maxlength="64"
                                                                        placeholder="Email address">
                                                                </div>
                                                            </div>
                                                            <div class="ui search focus mt-20">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4">
                                                            ...
                                                            <div class="ui search focus mt-15">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                                    <input class="prompt srch_explore" type="text"
                                                                        name="swiftcode" value=""
                                                                        id="id_swiftcode" required=""
                                                                        maxlength="64" placeholder="Swift-Code">
                                                                </div>
                                                            </div>
                                                            <div class="ui search focus mt-15">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                            ...
                                                            <div class="ui search focus mt-15">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                                    <input class="prompt srch_explore" type="text"
                                                                        name="bankname" value=""
                                                                        id="id_bankname" required="" maxlength="64"
                                                            ...
                                                            <div class="ui search focus mt-15">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                                    <input class="prompt srch_explore" type="text"
                                                                        name="address5" value=""
                                                                        id="id_address5" required="" maxlength="64"
                            ...
                            <div class="tab-pane fade" id="pills-api" role="tabpanel"
